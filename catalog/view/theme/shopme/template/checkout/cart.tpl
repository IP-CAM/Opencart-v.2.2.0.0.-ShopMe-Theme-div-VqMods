    	...
    	<div class="cart-info">
          <table cellspacing="0">
            ...
            <a onclick="$('#basket').submit();" data-toggle="tooltip" title="<?php echo $button_update; ?>" class="btn btn-dark btn-icon-sm hidden-md hidden-lg"><i class="fa fa-refresh"></i></a>
                ...
                <a onclick="cart.remove('<?php echo $product['cart_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-dark btn-icon-sm"><i class="fa fa-times"></i></a>
                </td>
              </tr>
              <?php } ?>
