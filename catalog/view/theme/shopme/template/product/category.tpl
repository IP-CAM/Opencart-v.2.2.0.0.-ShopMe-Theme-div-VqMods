...
<div class="container">
  ...
  <div class="row">
    ...
    <div id="content" class="<?php echo $class; ?> <?php echo $shopme_grid_category; ?>">
    <?php echo $content_top; ?>
  
  <h1><?php echo $heading_title; ?></h1>
  <?php if ($thumb || $description) { ?>
   <?php if ($thumb && $shopme_category_thumb) { ?>
  ...
  <?php if ($categories && $shopme_category_refine) { ?>
  <div class="bordered_content <?php echo $shopme_category_per_row; ?> categories_holder">
