...
class ControllerQuickCheckoutCheckout extends Controller { 
	public function index() {
		...
		if ($this->config->get('quickcheckout_countdown')) {
			...
			$this->document->addStyle('catalog/view/theme/shopme/stylesheet/quickcheckout.css');
		
		
		if ($this->config->get('quickcheckout_layout') == '1') {
			
				$data['stylesheet'] = 'catalog/view/theme/shopme/stylesheet/quickcheckout_one.css';
			
		} elseif ($this->config->get('quickcheckout_layout') == '2') {
			
				$data['stylesheet'] = 'catalog/view/theme/shopme/stylesheet/quickcheckout_two.css';
			
		} else {
			
				$data['stylesheet'] = 'catalog/view/theme/shopme/stylesheet/quickcheckout_three.css';
		
		}
		
		if ($this->config->get('quickcheckout_responsive')) {
			
				$data['mobile_stylesheet'] = 'catalog/view/theme/shopme/stylesheet/quickcheckout_mobile.css';
