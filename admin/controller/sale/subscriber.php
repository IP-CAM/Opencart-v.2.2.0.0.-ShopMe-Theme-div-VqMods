...
class ControllerSaleSubscriber extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('sale/subscriber', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('sale/subscriber', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['delete'] = $this->url->link('sale/subscriber/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		$pagination->url = $this->url->link('sale/subscriber', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
