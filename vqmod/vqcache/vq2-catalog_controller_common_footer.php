...
class ControllerCommonFooter extends Controller {
	public function index() {
		...
		$this->load->model('catalog/information');
			...
			if(empty($shopme_footer_block[$this->config->get('config_language_id')])) {
				$data['shopme_footer_custom_block'] = false;
			} else if (isset($shopme_footer_block[$this->config->get('config_language_id')])) {
				$data['shopme_footer_custom_block'] = html_entity_decode($shopme_footer_block[$this->config->get('config_language_id')], ENT_QUOTES, 'UTF-8');
			}
