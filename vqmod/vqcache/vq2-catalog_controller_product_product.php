...
if(empty($shopme_quicklook[$this->config->get('config_language_id')])) {
$data['shopme_text_ql'] = false;
} else if (isset($shopme_quicklook[$this->config->get('config_language_id')])) {
$data['shopme_text_ql'] = html_entity_decode($shopme_quicklook[$this->config->get('config_language_id')], ENT_QUOTES, 'UTF-8');
}
$data['in_content'] = $this->load->controller('common/in_content');
