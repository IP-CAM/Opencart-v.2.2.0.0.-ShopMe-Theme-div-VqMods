...
class ControllerCommonMenu extends Controller {
	public function index() {
		$this->load->language('common/menu');
			...
			$data['question_url'] = $this->url->link('catalog/question', 'token=' . $this->session->data['token'], true);
			...
			$data['blog_setting'] = $this->url->link('blog/blog_setting', 'token=' . $this->session->data['token'], true);
			$data['blog_category'] = $this->url->link('blog/blog_category', 'token=' . $this->session->data['token'], true);
			$data['blog_post'] = $this->url->link('blog/blog', 'token=' . $this->session->data['token'], true);
			$data['blog_comment'] = $this->url->link('blog/blog_comment', 'token=' . $this->session->data['token'], true);
			// Blog ends
...
$this->load->language('catalog/tab');
				...
				$data['product_tab'] = $this->url->link('catalog/tab', 'token=' . $this->session->data['token'], true);
		...
		$data['text_openbay_order_import'] = $this->language->get('text_openbay_order_import');
			...
			$data['subscriber'] = $this->url->link('sale/subscriber', 'token=' . $this->session->data['token'], true);
